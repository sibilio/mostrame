...
$teste = "Material de construção";

$regras = [
"/[ãàáâ]/ui", "/[éêẽè]/ui", "/[ç]/ui"
];
$sub = [
"a", "e", "c"
];

$teste = preg_replace($regras, $sub, $teste);
$teste = strtolower($teste);
$stop = StopWords::stop($teste);
...
class StopWords
{
    ...
    public static function words()
    {
        return [
            ...
            "tenham", "tivesse", "tivéssemos", "tivessem", "tiver", "tivermos", "tiverem", "terei", "terá", "teremos", "terão", "teria", "teríamos", "teriam", "xícara", "disse"
        ];
    }
}
